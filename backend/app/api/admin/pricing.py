...
def update_usd_rate(body: UsdRateUpdate, user: dict = Depends(require_admin)):
...
def create_rule(rule: MarkupRuleCreate, user: dict = Depends(require_admin)):
...
def update_rule(rule_id: int, body: MarkupRuleUpdate,
...
def price_preview(body: PricePreviewRequest,
                        user: dict = Depends(require_admin)):
