...
class Order(Base):
    ...
    # Traffic-source attribution (first-touch + latest/session).
    # All nullable: missing attribution must never break order creation.
    first_source = Column(String(100), nullable=True)
    first_medium = Column(String(100), nullable=True)
    first_campaign = Column(String(255), nullable=True)
    first_term = Column(String(255), nullable=True)
    first_content = Column(String(255), nullable=True)
    first_landing_page = Column(String(500), nullable=True)
    first_gclid = Column(String(255), nullable=True)
    last_source = Column(String(100), nullable=True)
    last_medium = Column(String(100), nullable=True)
    last_campaign = Column(String(255), nullable=True)
    last_term = Column(String(255), nullable=True)
    last_content = Column(String(255), nullable=True)
    last_landing_page = Column(String(500), nullable=True)
    last_gclid = Column(String(255), nullable=True)
