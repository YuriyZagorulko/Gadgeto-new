...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      'Публічний договір (оферта) інтернет-магазину Gadgeto на замовлення, купівлю-продаж і доставку товарів: визначення термінів, оформлення замовлення, ціна і доставка, права та обов’язки сторін, повернення товару, відповідальність та адреса і реквізити продавця.',
    alternates: {
      canonical: '/dogovir-oferty',
      languages: {uk: '/dogovir-oferty', 'x-default': '/dogovir-oferty'},
    },
  };
}
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:py-12">
      <article className="prose prose-neutral max-w-3xl mx-auto">
        ...
        <p>
          ...
          www.gadgeto.com.ua. Даний договір є публічним, тобто відповідно до
        ...
        <p>
          ...
          умови та порядок оформлення замовлення, оплати товару, доставки
          товару, повернення товару, відповідальності за недобросовісне
          замовлення та усі інші умови договору.
        </p>
        <p>
          Договір вважається укладеним з моменту натискання кнопки
        ...
        <section>
          ...
          <p>
            1.2. Товар або Послуга – об’єкт угоди сторін, який був обраний
            покупцем на сайті Інтернет-магазину та поміщений у кошик, або вже
            придбаний Покупцем у Продавця дистанційним способом.
          </p>
          <p>
            1.2. Інтернет-магазин – сайт Продавця за адресою
            www.gadgeto.com.ua створений для укладення договорів роздрібної та
          ...
          <p>
            1.4. Продавець – Фізична особа-підприємець Загорулько Юрій
            Олегович (ІПН 3476016835), що діє відповідно до чинного
            законодавства України, місцезнаходження: Україна, м. Дніпро, вул.
            Лубедина, буд. 63
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            через форму «Кошика», або зробивши замовлення електронною поштою чи
            за номером телефону, вказаним в розділі контактів Інтернет-магазину.
          </p>
          <p>
          ...
          <ol>
            ...
            <li>3.3.2. адреса, за якою слід доставити Товар (якщо доставка до адреси Покупця);</li>
            <li>3.3.3. контактний телефон.</li>
            <li>3.3.4. Ідентифікаційний код для юридичної особи або фізичної-особи підприємця.</li>
          </ol>
          <p>
          ...
          <ol>
            ...
            <li>
              б) він дає дозвіл на збір, обробку та передачу персональних
              даних, дозвіл на обробку персональних даних діє протягом усього
              терміну дії Договору, а також протягом необмеженого терміну після
...
<section>
        ...
        <section>
          ...
          <p>
            ...
            При пред’явленні вимог про безоплатне усунення недоліків, строк на
            їх усунення відраховується з дати отримання Товару Продавцем в своє
...
<section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Тел.: +380935091447</li>
            <li>Email: gadgeto602@gmail.com</li>
            <li>Сайт: https://gadgeto.com.ua</li>
          </ul>
        </section>
      </article>
    </div>
