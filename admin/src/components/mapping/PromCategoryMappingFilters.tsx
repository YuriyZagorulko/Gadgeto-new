...
export interface PromCategoryMappingFilters {
  ...
  externalCategoryIds: string;       // comma-separated external (Prom.ua) category IDs
  statusFilter: string;
}

interface Props {
  onApply: (filters: PromCategoryMappingFilters) => void;
}

export default function PromCategoryMappingFilterPanel({ onApply }: Props) {
    ...
    <div className="flex flex-wrap items-end gap-3 mb-4">
      ...
      <div className="w-64">
        <EntityMultiSelect
          ...
          idKey="external_id"
          nameKey="name"
          placeholder="Введіть для пошуку категорій Prom.ua..."
        />
      </div>
      <div>
