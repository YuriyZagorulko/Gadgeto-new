...
export interface PromAttributeMappingFilters {
...
interface Props {
  onApply: (filters: PromAttributeMappingFilters) => void;
}

export default function PromAttributeMappingFilterPanel({ onApply }: Props) {
